...
#define PARAM_BASE_ADDRESS              ( EEPROMHANDLER_PRMBLOCK_BASE_ADDR )
...
#define PARAM_UPDATE_BLOCK_SIZE         ( EEPROMHANDLER_BLK_SIZE )

/// define the macro to enable notifications
#define	PARAM_ENABLE_NOTIFICATIONS      ( OFF )

/// define the macro to enable callbacks
#define	PARAM_ENABLE_CALLBACKS          ( OFF )
