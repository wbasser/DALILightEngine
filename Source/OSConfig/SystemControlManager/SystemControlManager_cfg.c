...
const CODE  SYSCTRLMNGRSCHDDEF g_atSysCtrlMngrSchdDefs[ ] = 
{
  ...
  SYSCNTRLMNGRSCHD_DEF( TASK_SCHD_ENUM_MANRECV, OFF,   OFF,   OFF,   OFF,   ON,     ON,   OFF,   OFF,   OFF,   OFF,   OFF,    OFF,    OFF,    OFF,    OFF,    OFF,    NULL                       ),
  SYSCNTRLMNGRSCHD_DEF( TASK_SCHD_ENUM_DALIEVN, OFF,   OFF,   OFF,   OFF,   ON,     ON,   OFF,   OFF,   OFF,   OFF,   OFF,    OFF,    OFF,    OFF,    OFF,    OFF,    DALIMessageHandler_Control ), 
  SYSCNTRLMNGRSCHD_DEF( TASK_SCHD_ENUM_DALITIM, OFF,   OFF,   OFF,   OFF,   ON,     ON,   OFF,   OFF,   OFF,   OFF,   OFF,    OFF,    OFF,    OFF,    OFF,    OFF,    NULL                       ), 
  SYSCNTRLMNGRSCHD_DEF( TASK_SCHD_ENUM_DALIOUT, OFF,   OFF,   OFF,   OFF,   ON,     ON,   OFF,   OFF,   OFF,   OFF,   OFF,    OFF,    OFF,    OFF,    OFF,    OFF,    NULL                       ), 
  SYSCNTRLMNGRSCHD_DEF( TASK_SCHD_ENUM_DALIBSF, OFF,   OFF,   OFF,   OFF,   ON,     ON,   OFF,   OFF,   OFF,   OFF,   OFF,    OFF,    OFF,    OFF,    OFF,    OFF,    NULL                       ), 
};
...
static void LclConfigEntry( void )
{
  ...
  // call the parmeter config
  ParameterManager_Initialize( FALSE );
