...
extern  void  DbgAscCommandHandler_StartReceive( void );
...
extern  void  DbgAscCommandHandler_ResetPrompt( void );
extern  void  DbgAscCommandHandler_OutputDaliXmt( U8 nValue );
