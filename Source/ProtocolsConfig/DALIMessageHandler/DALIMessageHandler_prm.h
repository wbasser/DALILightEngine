...
/// define the first and last paraeter for default resets
#define DALI_PARAM_RST_FIRST_ENUM         ( DALI_PARAM_SHORT_ADDR )
#define DALI_PARAM_RST_LAST_ENUM          ( DALI_PARAM_MB0_PHYSICALMINLVL )
